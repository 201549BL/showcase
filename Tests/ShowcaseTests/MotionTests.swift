...
struct MotionTests {
    ...
    @Test("Manual framing: Small cursor tremor does not trigger a delayed camera micro-pan")
    ...
    @Test("Manual framing: Settled cursor-follow pan ignores a small same-direction tremor")
    ...
    @Test("Manual framing: Cursor smoothing tail does not postpone the camera rest gate")
    ...
    @Test("Manual framing: A real sparse cursor stream rearms before a later tremor")
    ...
    @Test("Manual framing: Slow intent crossing starts one smooth camera takeover")
    ...
    @Test("Manual framing: Small cursor tremor stays quiet during manual zoom-out")
    ...
    @Test("Manual framing: Overlapping manual shots preserve pending cursor intent")
    ...
    @Test("Manual framing: Overlapping shot handoff refreshes cursor intent scale")
    ...
    @Test("Manual framing: Cursor intent survives auto-hide and reappearance")
    ...
    @Test("Manual framing: Repeated cursor reappearances preserve accumulated intent")
    ...
    @Test("Manual framing: Repeated slow cursor steps accumulate into one intentional pan")
