...
final class WebcamRecorder: NSObject {
    ...
    private let sessionQueue = DispatchQueue(label: "SmoothScreen.WebcamSession")
    private let writerQueue = DispatchQueue(label: "SmoothScreen.WebcamWriter")
    ...
    func start(outputURL: URL, startTime: CMTime) async throws {
